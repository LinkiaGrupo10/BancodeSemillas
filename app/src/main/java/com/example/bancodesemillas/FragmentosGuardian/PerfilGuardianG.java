...
import com.example.bancodesemillas.FragmentosAdministrador.Cambio_Pass;
import com.example.bancodesemillas.MainActivityAdministrador;
import com.example.bancodesemillas.MainActivityGuardian;
...
public class PerfilGuardianG extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_perfil_guardiang, container, false);

        FotoPerfilGuardian = view.findViewById(R.id.FotoPerfilGuardianG);
        NombreGardian = view.findViewById(R.id.NombreGardianG);
        CorreoGuardian = view.findViewById(R.id.CorreoGuardianG);
        TelefonoGuardian = view.findViewById(R.id.TelefonoGuardianG);
        DireccionGuardian = view.findViewById(R.id.DireccionGuardianG);
        MunicipioGuardian = view.findViewById(R.id.MunicipioGuardianG);
        AsambleaGaurdian = view.findViewById(R.id.AsambleaGaurdianG);
        ActualizarPass = view.findViewById(R.id.ActualizarPassG);
        ActualizarDatos = view.findViewById(R.id.ActualizarDatosG);
    ...
    private boolean ComprobarPermisosCamara() {
        boolean resultado1 = ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA)
                == (PackageManager.PERMISSION_GRANTED);
        boolean resultado2 = ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
                == (PackageManager.PERMISSION_GRANTED);
                        ...
                        if (uriTask.isSuccessful()) {
                            ...
                            GUARDIANES.child(user.getUid()).updateChildren(results)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void unused) {
                                            startActivity(new Intent(getActivity(), MainActivityGuardian.class));
                                            getActivity().finish();
